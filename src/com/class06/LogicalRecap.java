...
public class LogicalRecap {
	...
	public static void main(String[] args) {
		/*
		 * we need to get time based on the time we need to identify what is the time of
		 * day if time is between 1-11-->morning 
		 * if time is between 12-13-->noon 
		 * if time is between 14-17-->afternoon 
		 * if time is between 18-21-->evening 
		 * if time isbetween 22-24-->night
		 */
		Scanner scan;
		int time;
		String timeOfTheDay;
		...
		System.out.println("Based on entered time it is "+timeOfTheDay);
